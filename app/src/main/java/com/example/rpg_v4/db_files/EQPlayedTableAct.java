...
import com.example.rpg_v4.db_files.adapter_classes.eqplayed_adapter;
import com.google.android.material.floatingactionbutton.FloatingActionButton;

import java.util.List;

public class EQPlayedTableAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final eqplayed_adapter adapter = new eqplayed_adapter(this);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(EQPlayedTableAct.this, dbCheckerActivity.class);
